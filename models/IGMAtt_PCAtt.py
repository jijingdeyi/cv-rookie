...
class CrossAttention(nn.Module):
    ...
    def forward(self, x1, x2, H, W):
        ...
        # B N C -> B N num_head C//num_head -> B  num_heads N head_dim
        ...
        #kv2 = self.kv2(x2).reshape(B2, -1, 2, self.num_heads, C2 // self.num_heads).permute(2, 0, 3, 1, 4) 
        k2, v2 = kv2[0], kv2[1] # B num_heads N' head_dim

        attn = (q1 @ k2.transpose(-2, -1)) * self.scale # B num_heads N N'
        attn = attn.softmax(dim=-1)
        attn = self.attn_drop(attn)
