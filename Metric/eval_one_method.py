...
if __name__ == '__main__':
    ...
    filename_list = ['']
    dataset_name = 'llvip'
    ir_dir = os.path.join(r'F:\dataset\LLVIP\subtest', 'ir')
    vi_dir = os.path.join(r'F:\dataset\LLVIP\subtest', 'vi')
    Method = 'ferfusion'
    f_dir = os.path.join(r'E:\BaiduSyncdisk\outputs\LLVIP\ferfusion')
    save_dir = r'C:\Users\26228\Desktop\paper3'
